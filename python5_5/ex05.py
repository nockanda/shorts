...
send_button1 = tk.Button(root, text="DC모터끄기!", command=lambda: send_to_arduino(0))
send_button1.pack()
send_button2 = tk.Button(root, text="DC모터켜기!", command=lambda: send_to_arduino(1))
send_button2.pack()
